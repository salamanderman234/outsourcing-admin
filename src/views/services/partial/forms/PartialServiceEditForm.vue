        ...
        <div class="mb-3">
                ...
                <CRow>
                    ...
                    <CCol :xs="12" :md="12" class="mb-3 mb-md-0 mt-3 d-flex">
                        <CButton 
                            ...
                            @click="() => removeRequiredItem(item.id, index)"
                        >
                            <CIcon :icon="cilTrash" />
                            Hapus
                        </CButton>
            ...
            <div v-for="(item,index) in newRequiredItems">
                <CRow>
                    <CCol :xs="6" :md="5" class="mb-3 mb-md-0">
                        <CFormLabel>Nama Item</CFormLabel>
                        <CFormInput placeholder="Nama Item" v-model="newRequiredItems[index].item_name"/>
                    </CCol>
                    <CCol :xs="6" :md="2" class="mb-3 mb-md-0">
                        <CFormLabel>Qty</CFormLabel>
                        <CFormInput placeholder="0" v-model="newRequiredItems[index].quantity"/>
                    </CCol>
                    <CCol :xs="12" :md="5" class="mb-3 mb-md-0">
                        <CFormLabel>Harga/item</CFormLabel>
                        <CFormInput placeholder="Harga Per Item" v-model="newRequiredItems[index].price_per_item"/>
                    </CCol>
                    <CRow class="mt-3 mx-0">
                        <CCol :xs="6" :md="6" class="mb-3 mb-md-0 d-flex px-0 pe-1">
                            <CButton color="danger" class="text-white w-100" @click="() => deleteNewRequiredItem(index)">
                                <CIcon :icon="cilTrash" />
                                Hapus
                            </CButton>
                        </CCol>
                        <CCol :xs="6" :md="6" class="mb-3 mb-md-0 d-flex px-0 ps-1">
                            <CButton 
                                color="success" 
                                class="text-white w-100" 
                                @click="() => saveRequiredItem(index)"
                            >
                                <CIcon :icon="cilSave" />
                                Simpan
                            </CButton>
            ...
            <div class="mb-3">
                    ...
                    <CRow>
                        ...
                        <CCol :xs="12" :md="12" class="mb-3 mb-md-0 mt-3 d-flex">
                            <CButton color="danger" class="text-white w-100" 
                                @click="() => removeAdditionalItem(item.id, index)"
                            >
                                <CIcon :icon="cilTrash" />
                                Hapus
                            </CButton>
                ...
                <div v-for="(item,index) in newAdditionalItems">
                    <CRow>
                        <CCol :xs="6" :md="4" class="mb-3 mb-md-0">
                            <CFormLabel>Nama Item</CFormLabel>
                            <CFormInput placeholder="Nama Item" v-model="newAdditionalItems[index].item_name"/>
                        </CCol>
                        <CCol :xs="6" :md="2" class="mb-3 mb-md-0">
                            <CFormLabel>Min</CFormLabel>
                            <CFormInput placeholder="0" v-model="newAdditionalItems[index].min_quantity"/>
                        </CCol>
                        <CCol :xs="6" :md="2" class="mb-3 mb-md-0">
                            <CFormLabel>Max</CFormLabel>
                            <CFormInput placeholder="0" v-model="newAdditionalItems[index].max_quantity"/>
                        </CCol>
                        <CCol :xs="12" :md="4" class="mb-3 mb-md-0">
                            <CFormLabel>Harga/item</CFormLabel>
                            <CFormInput placeholder="Harga Per Item" v-model="newAdditionalItems[index].price_per_item"/>
                        </CCol>
                        <CRow class="mt-3 mx-0">
                            <CCol :xs="6" :md="6" class="mb-3 mb-md-0 d-flex px-0 pe-1">
                                <CButton 
                                    color="danger" 
                                    class="text-white w-100" 
                                    @click="() => deleteNewAdditionalItem(index)"
                                >
                                    <CIcon :icon="cilTrash" />
                                    Hapus
                                </CButton>
                            ...
                            <CCol :xs="6" :md="6" class="mb-3 mb-md-0 d-flex px-0 ps-1">
                                <CButton 
                                    color="success" 
                                    class="text-white w-100" 
                                    @click="() => saveAdditionalItem(index)"
                                >
                                    <CIcon :icon="cilSave" />
                                    Simpan
                                </CButton>
